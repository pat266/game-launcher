...
namespace Launcher_VLCM_niua_lsaj.Forms
{
    public partial class Game : Form
    {
        ...
        {
            // exit
            exit.Image = (Image)Properties.Resources.ResourceManager.GetObject("close");
            exit.MinimumSize = new Size(30, 30);
            exit.MaximumSize = new Size(30, 30);

            // maximize
            maximize.Image = (Image)Properties.Resources.ResourceManager.GetObject("maximize");
            maximize.MinimumSize = new Size(30, 30);
            maximize.MaximumSize = new Size(30, 30);

            // minimize
            minimize.Image = (Image)Properties.Resources.ResourceManager.GetObject("minimize");
            minimize.MinimumSize = new Size(30, 30);
            minimize.MaximumSize = new Size(30, 30);

            // translation
            translationButton.Image = (Image)Properties.Resources.ResourceManager.GetObject("translation");
            translationButton.MinimumSize = new Size(30, 30);
            translationButton.MaximumSize = new Size(30, 30);

            // reset
            reset.Image = (Image)Properties.Resources.ResourceManager.GetObject("reset");
            reset.MinimumSize = new Size(30, 30);
            reset.MaximumSize = new Size(30, 30);

            // restart
            restart.Image = (Image)Properties.Resources.ResourceManager.GetObject("restart");
        ...
        private void Mute_Game()
        {
            ...
            SetVolume(0);
            // change the icon
            ApplicationSound.Image = (Image)Properties.Resources.ResourceManager.GetObject("mute");
        ...
        private void Unmute_Game()
        {
            ...
            SetVolume(10);
            // change the icon
            ApplicationSound.Image = (Image)Properties.Resources.ResourceManager.GetObject("unmute");
            // set the boolean value
            isMute = false;
        }
